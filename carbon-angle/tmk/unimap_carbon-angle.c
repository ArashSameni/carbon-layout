...
const action_t actionmaps[][UNIMAP_ROWS][UNIMAP_COLS] PROGMEM = {
    ...
    [0] = UNIMAP(
     ...
     GRV,   1,   2,   3,   4,   5,   6,   7,   8,   9,   0,LBRC,RBRC,JYEN,BSPC,      INS,HOME,PGUP,    NLCK,PSLS,PAST,PMNS,
     TAB,   B,   L,   D,   W,   Z,QUOT,   F,   O,   U,   J,SCLN, EQL,     BSLS,      DEL, END,PGDN,      P7,  P8,  P9,PPLS,
    CAPS,   N,   R,   T,   S,   G,   Y,   H,   A,   E,   I,COMM,     NUHS, ENT,                          P4,  P5,  P6,PCMM,
     FN0,NUBS,   X,   M,   C,   V,   Q,   K,   P, DOT,MINS,SLSH,       RO, FN1,            UP,           P1,  P2,  P3,PENT,
    ...
    TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,MINS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,     TRNS,     TRNS,TRNS,TRNS,    TRNS,TRNS,TRNS,TRNS,
    TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,SLSH,     TRNS,TRNS,                        TRNS,TRNS,TRNS,TRNS,
    TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,QUOT,COMM,     TRNS,TRNS,          TRNS,         TRNS,TRNS,TRNS,TRNS,
