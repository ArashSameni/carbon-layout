...
*SC00c::Send {Blind}{VKdbSC00c DownR} ; QWERTY -: [
*SC00c up::Send {Blind}{VKdbSC00c Up}
*SC00d::Send {Blind}{VKddSC00d DownR} ; QWERTY +: ]
*SC00d up::Send {Blind}{VKddSC00d Up}
...
*SC015::Send {Blind}{VKdeSC015 DownR} ; QWERTY Y: '
*SC015 up::Send {Blind}{VKdeSC015 Up}
*SC016::Send {Blind}{VK46SC016 DownR} ; QWERTY U: F
*SC016 up::Send {Blind}{VK46SC016 Up}
*SC017::Send {Blind}{VK4fSC017 DownR} ; QWERTY I: O
*SC017 up::Send {Blind}{VK4fSC017 Up}
*SC018::Send {Blind}{VK55SC018 DownR} ; QWERTY O: U
*SC018 up::Send {Blind}{VK55SC018 Up}
*SC019::Send {Blind}{VK4aSC019 DownR} ; QWERTY P: J
*SC019 up::Send {Blind}{VK4aSC019 Up}
*SC01a::Send {Blind}{VKbaSC01a DownR} ; QWERTY [: ;
*SC01a up::Send {Blind}{VKbaSC01a Up}
...
*SC024::Send {Blind}{VK48SC024 DownR} ; QWERTY J: H
*SC024 up::Send {Blind}{VK48SC024 Up}
*SC025::Send {Blind}{VK41SC025 DownR} ; QWERTY K: A
*SC025 up::Send {Blind}{VK41SC025 Up}
*SC026::Send {Blind}{VK45SC026 DownR} ; QWERTY L: E
*SC026 up::Send {Blind}{VK45SC026 Up}
*SC027::Send {Blind}{VK49SC027 DownR} ; QWERTY ;: I
*SC027 up::Send {Blind}{VK49SC027 Up}
*SC028::Send {Blind}{VKbcSC028 DownR} ; QWERTY ': ,
*SC028 up::Send {Blind}{VKbcSC028 Up}
*SC02c::Send {Blind}{VK51SC02c DownR} ; QWERTY Z: Q
*SC02c up::Send {Blind}{VK51SC02c Up}
...
*SC032::Send {Blind}{VK50SC032 DownR} ; QWERTY M: P
*SC032 up::Send {Blind}{VK50SC032 Up}
*SC033::Send {Blind}{VKbeSC033 DownR} ; QWERTY ,: .
*SC033 up::Send {Blind}{VKbeSC033 Up}
*SC034::Send {Blind}{VKbdSC034 DownR} ; QWERTY .: -
*SC034 up::Send {Blind}{VKbdSC034 Up}
...
; QWERTY -
#if
SC00c::Send {Blind}{U+005b} ; [
+SC00c::Send {Blind}{U+007b} ; {
>!<^SC00c::Return
+>!<^SC00c::Return

; QWERTY +
#if
SC00d::Send {Blind}{U+005d} ; ]
+SC00d::Send {Blind}{U+007d} ; }
>!<^SC00d::Return
+>!<^SC00d::Return
...
; QWERTY Y
#if
SC015::Send {Blind}{U+0027} ; '
+SC015::Send {Blind}{U+005f} ; _
>!<^SC015::Return
+>!<^SC015::Return
...
; QWERTY [
#if
SC01a::Send {Blind}{U+003b} ; ;
+SC01a::Send {Blind}{U+003a} ; :
>!<^SC01a::Return
+>!<^SC01a::Return
...
; QWERTY '
#if
SC028::Send {Blind}{U+002c} ; ,
+SC028::Send {Blind}{U+003f} ; ?
>!<^SC028::Return
+>!<^SC028::Return
...
; QWERTY ,
#if
SC033::Send {Blind}{U+002e} ; .
+SC033::Send {Blind}{U+003e} ; >
>!<^SC033::Return
+>!<^SC033::Return

; QWERTY .
#if
SC034::Send {Blind}{U+002d} ; -
+SC034::Send {Blind}{U+0022} ; "
>!<^SC034::Return
+>!<^SC034::Return
